 ...
 */
//*Changes to build stand-alone runnable dist 
//BufferedImageLoader
//JPane custom code
//map background imageio.read and other data streams in this class
//startScreen copy over
//loadForm copy over
//back to main menu button drawing and code- copy over
...
public class BellumDeorum extends JPanel implements java.io.Serializable, Runnable, MouseListener, KeyListener, WindowListener {
    ...
    public void sprites() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Image Load Failed: " + e);
        }
    ...
    public void save(String fileName) {
        try {
            ...
            JOptionPane.showMessageDialog(null, "Exception thrown during test: " + ex.toString());
        }
